...
![Account settings menu, Personal access tokens](https://csprodstorage001.blob.core.windows.net/blog/step1-azuredevops-accountsettings.png)
...
![List of Personal access tokens](https://csprodstorage001.blob.core.windows.net/blog/step1-azuredevops-patlist.png)

The form to create the Personal access token is displayed:

![Create PAT form](https://csprodstorage001.blob.core.windows.net/blog/step1-azuredevops-patcreate.png)
...
![Create Personal access token success](https://csprodstorage001.blob.core.windows.net/blog/step1-azuredevops-patsuccess.png)
...
![Create Personal access token regenerate](https://csprodstorage001.blob.core.windows.net/blog/step1-azuredevops-patregenerate.png)
